        ...
        return (
            <div className="grid items-center max-w-xl border-solid border border-gray-200 rounded-2xl mb-9">
                ...
                <div className='flex items-center'>
                    <button onClick={this.onLikePressed} className={this.state.liked ? "group bg-red-300 border-solid border border-red-500 rounded-full mb-2 ml-2 hover:bg-red-200 hover:border-red-400 hover:cursor-pointer" : "group bg-gray-100 border-solid border border-bottom-icon-border-color rounded-full mb-2 ml-2 hover:bg-red-100 hover:border-red-400 hover:cursor-pointer"}>
                        <RiHeartFill className={this.state.liked ? 'w-6 h-auto fill-red-500 px-5 group-hover:fill-red-400' : 'w-6 h-auto fill-bottom-icon-color px-5 group-hover:fill-red-400'} />
                    </button>
